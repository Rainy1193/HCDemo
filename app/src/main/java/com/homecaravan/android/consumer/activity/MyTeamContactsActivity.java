...
public class MyTeamContactsActivity extends BaseActivity implements IContactManager {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mFragmentFeatured.setContactListener(this);
    ...
    public void pickContact(ContactManagerData managerData, String id, int position, boolean b) {
        ...
        if (b) {
            if (mArrContactInvited.isEmpty()) {
                AnimUtils.slideUp(this, mLayoutDone);
            }
            ...
            if (mArrContactInvited.isEmpty()) {
                AnimUtils.slideDown(this, mLayoutDone);
            }
        }
        Log.e("mArrContactInvited", mArrContactInvited.toString());
