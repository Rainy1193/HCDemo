...
public class HomeInspectorMyResourceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private boolean mBorderAvatarImage;
    private FragmentTeamChild fragmentTeamChild;
    private ArrayList<ConsumerTeam> mArrTeam;

    public HomeInspectorMyResourceAdapter(Context mContext, boolean mBorderAvatarImage, FragmentTeamChild fragmentTeamChild, ArrayList<ConsumerTeam> mArrTeam) {
