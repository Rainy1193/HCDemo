...
public class JustListedDashboardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public JustListedDashboardAdapter(Context mContext, ArrayList<BaseDataRecyclerView> mArrListing, IDashboardListener mListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.just_listed_item, parent, false);
        ...
        if (holder instanceof HeaderHolder) {
            ...
            headerHolder.mLayoutHeader.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    CurrentSaveSearch.getInstance().setId("justlist");
                    CurrentSaveSearch.getInstance().setName("All Just Listed");
                    mListener.openDiscover("Just Listed");
                }
            });
            ...
            ListingDashboard justListed = (ListingDashboard) mArrListing.get(position);
            ListingHolder listingHolder = (ListingHolder) holder;
            if (justListed.getListingFull().getListingImages() != null) {
                Glide.with(mContext.getApplicationContext()).
                        load(justListed.getListingFull().getListingImages().getImage())
                        .asBitmap().fitCenter().placeholder(R.drawable.no_image_b).dontAnimate().into(listingHolder.mIvListing);
            }
            ...
            listingHolder.mPrice.setText(Utils.getPrice(justListed.getListingFull().getPrice().getValue()));
            listingHolder.mAddress1.setText(justListed.getListingFull().getAddress().getAddress1());
            listingHolder.mAddress2.setText(justListed.getListingFull().getAddress().getCity());
        }
    }
