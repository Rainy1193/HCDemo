...
public class LenderMyResourceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private boolean mBorderAvatarImage;
    private FragmentTeamChild fragmentTeamChild;
    private ArrayList<ConsumerTeam> mArrTeam;

    public LenderMyResourceAdapter(Context mContext, boolean mBorderAvatarImage, FragmentTeamChild fragmentTeamChild, ArrayList<ConsumerTeam> mArrTeam) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        lenderHolder.mLayoutItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                tvSetExclusive.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        fragmentTeamChild.showSelectedLender(lender);
                        alertDialog.dismiss();
                    }
                });
