...
public class MyContactManagerActiveAdapter extends RecyclerView.Adapter<MyContactManagerActiveAdapter.ContactManagerHolder> {
    private ArrayList<ContactManagerData> mArrContact;
    private Context mContext;
    private IContactManager mListener;

    public MyContactManagerActiveAdapter(ArrayList<ContactManagerData> mArrContact, Context mContext, IContactManager mListener) {
    ...
    @Override
    public MyContactManagerActiveAdapter.ContactManagerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_contact_manager_active_item, parent, false);
        return new ContactManagerHolder(v);
    }

    @Override
    public void onBindViewHolder(final MyContactManagerActiveAdapter.ContactManagerHolder holder, final int position) {
