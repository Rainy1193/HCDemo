...
public class ConsumerListingFullStatus extends BaseDataRecyclerView {
    private ConsumerListingFull listing;
    ...
    public ConsumerListingFull getListing() {
        return listing;
    }

    public void setListing(ConsumerListingFull listing) {
