...
import com.homecaravan.android.consumer.adapter.ContactManagerPendingAdapter;
...
public class FragmentPendingContact extends BaseFragment implements GetListContactView, IContactManager {
    ...
    private ContactManagerPendingAdapter mContactManagerAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mContactManagerAdapter = new ContactManagerPendingAdapter(mArrBaseContact, getActivity(), this);
    ...
    protected int getLayoutResourceId() {
        return R.layout.fragment_pending_contact;
    }
