...
public class FragmentSubmitReviews extends BaseFragment {
...
//    BubbleSeekBar mSbPrice;
    ...
    @Bind(R.id.tvAdd2)
    TextView mAdd2;
    @Bind(R.id.tvAdd1Submit)
    TextView mAdd1Submit;
    @Bind(R.id.tvAdd2Submit)
    TextView mAdd2Submit;
    @Bind(R.id.tvPrice)
    TextView mPrice;
    @Bind(R.id.tvPriceSubmit)
    TextView mPriceSubmit;
    @Bind(R.id.tvListed)
    TextView mListed;
    @Bind(R.id.tvListedSubmit)
    TextView mListedSubmit;


    @OnClick(R.id.edtComment)
    public void onClickComment() {
        AnimUtils.scrolling(mScrollView, (int) mEdtComment.getY());
    }

    @OnFocusChange(value = R.id.edtComment)
    public void onFocusChangeComment(boolean b) {
        if (b) {
            AnimUtils.scrolling(mScrollView, (int) mEdtComment.getY());
        }
    }
    ...
    @OnClick(R.id.edtPrivateNote)
    public void onClickPrivateNote() {
        AnimUtils.scrolling(mScrollView, (int) mEdtPrivateNote.getY());
    }

    @OnFocusChange(value = R.id.edtPrivateNote)
    public void onFocusChangePrivateNote(boolean b) {
        if (b) {
            AnimUtils.scrolling(mScrollView, (int) mEdtPrivateNote.getY());
        }
    }
    ...
    protected int getLayoutResourceId() {
        return R.layout.activity_submit_reviews;
    }
    ...
    public void initData() {
        ...
        ConsumerListingFullStatus listing1 = justListed.get(0);
        ArrayList<ImageListingConsumer> images = listing1.getListing().getArrImageListing();
        ...
        ConsumerListingFull listing = justListed.get(0).getListing();
        mAdd1.setText(listing.getAdd1());
        mAdd2.setText(listing.getCity());
        mPrice.setText(Utils.getPrice(listing.getPrice()));
        mListed.setText(Utils.getDateCreate(listing.getCreatedTime()));

        mAdd1Submit.setText(listing.getAdd1());
        mAdd2Submit.setText(listing.getCity());
        mPriceSubmit.setText(Utils.getPrice(listing.getPrice()));
        mListedSubmit.setText(Utils.getDateCreate(listing.getCreatedTime()));
        mLayoutButton.post(new Runnable() {
            @Override
            public void run() {
                mHeightShowLayout = mLayoutContent.getY();
    ...
    public void showLayout() {
        ...
        mLayoutReviewsResult.setVisibility(View.GONE);
...
//    }
    ...
    void onSubmitClicked() {
        ...
        ObjectAnimator objectAnimator = AnimUtils.animationButtonMenuWithOpenViewWithListener(null, mLayoutReviewsResult, true);
