 ...
 * 
 */
public class FlipHorizontalToAnimation extends com.homecaravan.android.consumer.utils.Animation {
	 ...
	 *         chained.
	 */
	public FlipHorizontalToAnimation setListener(Animation.AnimationListener listener) {
