...
import com.homecaravan.android.consumer.utils.BubbleUtils;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;
import java.math.BigDecimal;

import static com.homecaravan.android.consumer.utils.BubbleUtils.dp2px;
import static com.homecaravan.android.consumer.utils.BubbleUtils.sp2px;
import static com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.SIDES;
...
public class BubbleSeekBar extends View {
    ...
    @com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition
    ...
    private com.homecaravan.android.consumer.widget.BubbleSeekBar.OnProgressChangedListener mProgressListener; // progress changing listener
    ...
    private com.homecaravan.android.consumer.widget.BubbleSeekBar.BubbleView mBubbleView;
    ...
    private boolean mIsCustomBubbleSeekBar = false;
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (pos == 0) {
            ...
            mSectionTextPosition = com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
        } else if (pos == 2) {
            mSectionTextPosition = com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
        } else {
        ...
        // init BubbleView
        mBubbleView = new com.homecaravan.android.consumer.widget.BubbleSeekBar.BubbleView(context);

        //my code
        if (mIsCustomBubbleSeekBar) {
            String textOfBubble = "";
            if (isShowProgressInFloat) {
                float progress = getProgressFloat();
                float startText = progress - 50;
                float endText = progress + 50;
                if (startText <= mMin)
                    startText = mMin;
                if (endText >= mMax)
                    endText = mMax;
                textOfBubble = "$" + startText + "K - $" + endText + "K";
            } else {
                int progress = getProgress();
                int startText = progress - 50;
                int endText = progress + 50;
                if (startText <= mMin)
                    startText = (int) mMin;
                if (endText >= mMax)
                    endText = (int) mMax;
            ...
            mBubbleView.setProgressText(textOfBubble);
        } else {
    ...
    private void initConfigByPriority() {
        ...
        if (isShowSectionText) {
            if (mSectionTextPosition == NONE) {
                mSectionTextPosition = com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.SIDES;
            }
            if (mSectionTextPosition == com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK) {
        ...
        mThumbTextSize = isFloatType || isSeekBySection || (isShowSectionText && mSectionTextPosition ==
                com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK) ? mSectionTextSize : mThumbTextSize;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isShowSectionText && mSectionTextPosition >= com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BOTTOM_SIDES) { // 如果Section值在track之下显示，比较取较大值
        ...
        if (isShowSectionText) {
            ...
            if (mSectionTextPosition == com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.SIDES) {
            ...
            } else if (mSectionTextPosition >= com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BOTTOM_SIDES) {
                String text = getMinText();
                mPaint.getTextBounds(text, 0, text.length(), mRectText);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowSectionText) {
            ...
            if (mSectionTextPosition == com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.SIDES) {
                ...
                y_ += mRectText.height();
                xLeft = mLeft;
                if (mSectionTextPosition == com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BOTTOM_SIDES) {
        ...
        if ((!isShowSectionText && !isShowThumbText) || mSectionTextPosition == com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.SIDES) {
        ...
        boolean isShowTextBelowSectionMark = isShowSectionText && mSectionTextPosition ==
                com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
        ...
        if (isShowThumbText && !isThumbOnDragging && isTouchToSeekAnimEnd) {
            ...
            if (isFloatType || (isShowProgressInFloat && mSectionTextPosition == com.homecaravan.android.consumer.widget.BubbleSeekBar.TextPosition.BOTTOM_SIDES &&
    ...
    public com.homecaravan.android.consumer.widget.BubbleSeekBar.OnProgressChangedListener getOnProgressChangedListener() {
        return mProgressListener;
    }

    public void setOnProgressChangedListener(com.homecaravan.android.consumer.widget.BubbleSeekBar.OnProgressChangedListener onProgressChangedListener) {
        mProgressListener = onProgressChangedListener;
    }

    public void customBubbleSeekBar(boolean isCustomBubbleSeekBar) {
        this.mIsCustomBubbleSeekBar = isCustomBubbleSeekBar;
    }
     ...
     */
    public static abstract class OnProgressChangedListenerAdapter implements com.homecaravan.android.consumer.widget.BubbleSeekBar.OnProgressChangedListener {
    ...
    private class BubbleView extends View {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            setMeasuredDimension(5 * mBubbleRadius + 25, 3 * mBubbleRadius);
//            setMeasuredDimension(3 * mBubbleRadius, 3 * mBubbleRadius);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float y0 = getMeasuredHeight() - mBubbleRadius / 7f; // /2f
            mBubblePath.moveTo(x0, y0);
            float x1 = (float) (x0 - Math.sqrt(3) / 2f * mBubbleRadius);
            float y1 = 3 / 2f * mBubbleRadius;
            float x2 = (float) (x0 + Math.sqrt(3) / 2f * mBubbleRadius);


            if (mIsCustomBubbleSeekBar) {
                //my code
                //Draw bubble message path
//            mBubblePath.lineTo(x1+30, y1+70);
//            mBubblePath.lineTo(x2-30, y1+70);
                mBubblePath.lineTo(165, 180);
                mBubblePath.lineTo(235, 180);
                mBubblePath.lineTo(x0, y0);
                mBubblePath.addRect(-320, 180, 520, 55, Path.Direction.CW);
                //end my code
            } else {
//                Draw bubble droplets path
                mBubblePath.quadTo(
            ...
            float baseline = mBubbleRadius + (fm.descent - fm.ascent) / 2f - fm.descent + 50;
//            float baseline = mBubbleRadius + (fm.descent - fm.ascent) / 2f - fm.descent;
            canvas.drawText(mProgressText, x0, baseline, mBubblePaint);
