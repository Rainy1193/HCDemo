 ...
 * support both {@link CustomLayoutManagerSelect#HORIZONTAL} and {@link CustomLayoutManagerSelect#VERTICAL} scroll.
 * Created by chensuilun on 2016/11/18.
 */
public class CustomLayoutManagerSelect extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public CustomLayoutManagerSelect(int orientation) {
    ...
    public RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (mOrientation == VERTICAL) {
            return new CustomLayoutManagerSelect.LayoutParams(
    ...
    /**
     * Layout the item view witch position specified by {@link CustomLayoutManagerSelect#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    /**
     * Layout the item view witch position special by {@link CustomLayoutManagerSelect#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    private float calculateToCenterFraction(View child, float pendingOffset) {
        ...
        int childLength = mOrientation == CustomLayoutManagerSelect.HORIZONTAL ? child.getWidth() : child.getHeight();
    ...
    private int calculateDistanceCenter(View child, float pendingOffset) {
        ...
        if (mOrientation == CustomLayoutManagerSelect.HORIZONTAL) {
    ...
    public interface ItemTransformer {
         ...
         */
        void transformItem(CustomLayoutManagerSelect layoutManager, View item, float fraction);
    }
    ...
    /**
     * Implement to support {@link CustomLayoutManagerSelect#smoothScrollToPosition(RecyclerView, RecyclerView.State, int)}
     */
