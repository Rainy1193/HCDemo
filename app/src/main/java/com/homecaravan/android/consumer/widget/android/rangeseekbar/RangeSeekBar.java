...
package com.homecaravan.android.consumer.widget.android.rangeseekbar;
...
import com.homecaravan.android.consumer.model.EventSeekBar;
import com.homecaravan.android.consumer.widget.android.util.BitmapUtil;
import com.homecaravan.android.consumer.widget.android.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.ic_consumer_showing_seekbar_thumb;
        int thumbPressed = R.drawable.ic_consumer_showing_seekbar_thumb;
        int thumbDisabled = R.drawable.ic_consumer_showing_seekbar_thumb;
        ...
        if (attrs == null) {
            ...
            try {
                ...
                mShowLabels = a.getBoolean(R.styleable.RangeSeekBar_showLabels, false);
                ...
                mActiveColor = a.getColor(R.styleable.RangeSeekBar_activeColor, Color.parseColor("#179FEB"));
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (pressedThumb != null) {
                    ...
                    EventBus.getDefault().post(new EventSeekBar(getSelectedMaxValue(),getSelectedMinValue()));
