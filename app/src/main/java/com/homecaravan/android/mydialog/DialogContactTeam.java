 ...
 */
public class DialogContactTeam extends DialogFragment {
    @Bind(R.id.tvPhone)
    ...
    public static DialogContactTeam getInstance(String phone, String name, String email, String id, String lid) {
        phoneAgent = phone;
        nameContact = name;
        emailContact = email;
        idContact = id;
        idListing = lid;
        return new DialogContactTeam();
    }
