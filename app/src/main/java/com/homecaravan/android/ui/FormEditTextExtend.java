...
/**
 * Created by vankhoadesign on 7/21/16.
 */
public class FormEditTextExtend  extends MaterialEditText {
    public FormEditTextExtend(Context context) {
        super(context);
        //support dynamic new FormEditText(context)
        editTextValidator = new DefaultEditTextValidator(this, context);
    }

    public FormEditTextExtend(Context context, AttributeSet attrs) {
        super(context, attrs);
        editTextValidator = new DefaultEditTextValidator(this, attrs, context);
    }

    public FormEditTextExtend(Context context, AttributeSet attrs, int defStyle) {
