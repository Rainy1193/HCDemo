...
/**
 * Created by vankhoadesign on 7/13/16.
 */
public class HCSwithButton extends CompoundButton  {
    ...
    public HCSwithButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public HCSwithButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public HCSwithButton(Context context) {
        super(context);
        init(null);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            thumbRadius = ta.getDimension(com.kyleduo.switchbutton.R.styleable.SwitchButton_kswThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = ta.getDimension(com.kyleduo.switchbutton.R.styleable.SwitchButton_kswBackRadius, thumbRadius + density * 2f);
            ...
            backMeasureRatio = ta.getFloat(com.kyleduo.switchbutton.R.styleable.SwitchButton_kswBackMeasureRatio, backMeasureRatio);
            ...
            textMarginH = ta.getDimension(com.kyleduo.switchbutton.R.styleable.SwitchButton_kswTextMarginH, textMarginH);
            ta.recycle();
        }
    ...
    private int measureWidth(int widthMeasureSpec) {
        ...
        Log.d("DisplayMetrics",String.valueOf(DisplayMetrics.DENSITY_DEFAULT));

        Log.d("mTextWidth px",String.valueOf(dpToPx(230)));
        Log.d("minWidth px",String.valueOf(dpToPx(330)));

        Log.d("mTextWidth dp",String.valueOf(pxToDp(230)));
        Log.d("minWidth dp",String.valueOf(pxToDp(330)));


        mTextWidth = dpToPx(91);
        minWidth = dpToPx(131);
